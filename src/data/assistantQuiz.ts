...
export const assistantTranslations = {
  he: {
    title: "Calc-E העוזר האינטראקטיבי",
    badge: "עזרה וטיפים",
    subtitle: "ניווט וחישוב מהיר",
    guidedQuizTab: "שאלון מודרך",
    quickCalcTab: "חישוב מהיר",
    tipsTab: "טיפים וכללי זהב",
    ...
    searchPlaceholder: "חפש מחשבון או כלי...",
    noResults: "לא נמצאו מחשבונים תואמים",
    quickTip: "טיפ: בחר תחום כדי להגיע מיד לחישוב הנכון!",
    allCalculators: "לכל המחשבונים",
    filterTips: "סנן לפי נושא:",
    allCategories: "הכל",
    ruleFormula: "נוסחה / כלל:",
    goToTool: "פתח מחשבון ייעודי",
    instantCalc: "חישוב אחוזים מיידי",
    calcXofY: "מהו X% מתוך Y?",
    calcDiscount: "חישוב מחיר אחרי הנחה",
    calcRule72: "כלל 72 (הכפלת הון)",
    rateInput: "ריבית שנתית (%)",
    yearsToDouble: "שנים להכפלת הסכום",
    yearsLabel: "שנים",
    valueX: "אחוז (%)",
    valueY: "סכום (Y)",
    ...
    savingsAmount: "סכום החיסכון",
    copyBtn: "העתק טיפ",
    rule72Explain: "בקירוב: 72 חלקי הריבית השנתית נותן את מספר השנים להכפלת הקרן.",
  },
  en: {
    title: "Calc-E Interactive Assistant",
    badge: "Help & Tips",
    subtitle: "Navigation & Instant Tools",
    guidedQuizTab: "Guided Quiz",
    quickCalcTab: "Quick Calc",
    tipsTab: "Golden Tips",
    searchTab: "Search",
    startQuiz: "🎯 Find Calculator via Quiz",
    restartQuiz: "🔄 Restart Quiz",
    back: "Back",
    recommended: "Recommended for you:",
    openCalculator: "Open Calculator",
    searchPlaceholder: "Search calculators or tools...",
    ...
    filterTips: "Filter by topic:",
    allCategories: "All",
    ruleFormula: "Rule / Formula:",
    goToTool: "Open dedicated tool",
    instantCalc: "Instant % Calculation",
    calcXofY: "What is X% of Y?",
    calcDiscount: "Discount price calculation",
    calcRule72: "Rule of 72 (Doubling Time)",
    rateInput: "Annual Interest Rate (%)",
    yearsToDouble: "Years to double wealth",
    yearsLabel: "Years",
    valueX: "Percentage (%)",
    valueY: "Amount (Y)",
    ...
    copyBtn: "Copy tip",
    rule72Explain: "Approximate: 72 divided by the annual rate gives the years to double your initial capital.",
  },
  es: {
    title: "Calc-E Asistente Interactivo",
    badge: "Ayuda y Consejos",
    subtitle: "Navegación y Cálculo Rápido",
    guidedQuizTab: "Guía Interactiva",
    quickCalcTab: "Cálculo Rápido",
    tipsTab: "Consejos Clave",
    searchTab: "Búsqueda",
    ...
    filterTips: "Filtrar por tema:",
    allCategories: "Todos",
    ruleFormula: "Regla / Fórmula:",
    goToTool: "Abrir herramienta",
    instantCalc: "Cálculo de % instantáneo",
    calcXofY: "¿Cuánto es X% de Y?",
    calcDiscount: "Calcular precio con descuento",
    calcRule72: "Regla del 72 (Duplicar capital)",
    rateInput: "Tasa anual (%)",
    yearsToDouble: "Años para duplicar capital",
    yearsLabel: "Años",
    valueX: "Porcentaje (%)",
    valueY: "Monto (Y)",
    ...
    savingsAmount: "Monto ahorrado",
    copyBtn: "Copiar consejo",
    rule72Explain: "Aproximación: 72 dividido por la tasa de interés anual indica los años requeridos para duplicar tu dinero.",
  },
  fr: {
    title: "Calc-E Assistant Interactif",
    badge: "Aide & Astuces",
    subtitle: "Navigation & Calcul Rapide",
    guidedQuizTab: "Quiz Guidé",
    quickCalcTab: "Calcul Rapide",
    tipsTab: "Conseils d'Or",
    searchTab: "Recherche",
    ...
    filterTips: "Filtrer par thème :",
    allCategories: "Tous",
    ruleFormula: "Règle / Formule :",
    goToTool: "Ouvrir l'outil dédié",
    instantCalc: "Calcul de % instantané",
    calcXofY: "Que vaut X% de Y ?",
    calcDiscount: "Calcul de remise immédiate",
    calcRule72: "Règle des 72 (Doubler l'épargne)",
    rateInput: "Taux annuel (%)",
    yearsToDouble: "Années pour doubler le capital",
    yearsLabel: "Années",
    valueX: "Pourcentage (%)",
    valueY: "Montant (Y)",
    ...
    copyBtn: "Copier l'astuce",
    rule72Explain: "Approximation : 72 divisé par le taux d'intérêt annuel donne le nombre d'années nécessaires pour doubler le capital.",
  },
  ar: {
    title: "Calc-E المساعد التفاعلي",
    badge: "مساعدة ونصائح",
    subtitle: "توجيه وحسابات فورية",
    guidedQuizTab: "دليل تفاعلي",
    quickCalcTab: "حساب سريع",
    tipsTab: "نصائح ذهبية",
    searchTab: "بحث",
    startQuiz: "🎯 اعثر على الحاسبة المناسبة",
    restartQuiz: "🔄 إعادة الاختبار",
    back: "رجوع",
    recommended: "الحاسبة الموصى بها:",
    ...
    filterTips: "تصفية حسب الموضوع:",
    allCategories: "الكل",
    ruleFormula: "القاعدة / المعادلة:",
    goToTool: "افتح الحاسبة المخصصة",
    instantCalc: "حساب فوري للنسبة المئوية",
    calcXofY: "ما هي قيمة X% من Y؟",
    calcDiscount: "حساب السعر بعد الخصم",
    calcRule72: "قاعدة 72 (مضاعفة رأس المال)",
    rateInput: "الفائدة السنوية (%)",
    yearsToDouble: "السنوات لمضاعفة المبلغ",
    yearsLabel: "سنوات",
    valueX: "النسبة (%)",
    valueY: "المبلغ (Y)",
    ...
    savingsAmount: "مبلغ التوفير",
    copyBtn: "نسخ النصيحة",
    rule72Explain: "تقريب رياضي: 72 مقسومًا على معدل الفائدة السنوي يمنحك عدد السنوات المطلوبة لمضاعفة رأس المال.",
  },
};

export const assistantTips: AssistantTip[] = [
  {
    id: "rule_72",
    category: "finance",
    icon: "trending_up",
    title: {
      he: "כלל 72 להכפלת הון",
      en: "The Rule of 72 for Investments",
      es: "Regla del 72 para Inversiones",
      fr: "La Règle des 72 pour l'Investissement",
      ar: "قاعدة 72 لمضاعفة رأس المال",
    },
    summary: {
      he: "רוצה לדעת תוך כמה זמן כספך יוכפל בריבית דריבית? חלק 72 באחוז הריבית השנתית.",
      en: "Want to know when your money doubles? Divide 72 by the annual interest rate.",
      es: "¿Quieres saber cuándo se duplica tu dinero? Divide 72 entre la tasa de interés anual.",
      fr: "Pour savoir quand votre argent double, divisez 72 par le taux d'intérêt annuel.",
      ar: "لمعرفة متى يتضاعف مالك مع الفائدة المركبة، اقسم 72 على نسبة الفائدة السنوية.",
    },
    formulaOrRule: "Years = 72 / InterestRate%",
    calcPath: "/compound-interest",
  },
  {
    id: "rule_50_30_20",
    category: "finance",
    icon: "pie_chart",
    title: {
      he: "כלל התקציב 50/30/20",
      en: "The 50/30/20 Budget Rule",
      es: "Regla Presupuestaria 50/30/20",
      fr: "La Règle Budgétaire 50/30/20",
      ar: "قاعدة الميزانية 50/30/20",
    },
    summary: {
      he: "חלק את ההכנסה נטו: 50% לצרכים הכרחיים, 30% לרצונות ופנאי, ו-20% לחיסכון והשקעות.",
      en: "Split net income: 50% for needs, 30% for wants, and 20% for savings & investments.",
      es: "Divide tus ingresos netos: 50% necesidades, 30% deseos y 20% ahorro e inversión.",
      fr: "Répartissez vos revenus nets : 50% besoins, 30% loisirs et 20% épargne.",
      ar: "قسم دخلك الصافي: 50% للاحتياجات، 30% للرغبات، و20% للادخار والاستثمار.",
    },
    formulaOrRule: "50% Needs | 30% Wants | 20% Savings",
    calcPath: "/salary-calculator",
  },
  {
    id: "mortgage_30_rule",
    ...
    icon: "home",
    title: {
      he: "כלל ה-30% בהחזר משכנתא",
      en: "The 30% Mortgage Rule",
      es: "Regla del 30% para Hipotecas",
      fr: "Règle des 30% d'Endettement",
      ar: "قاعدة 30% للرهن العقاري",
    },
    summary: {
      he: "ההחזר החודשי של המשכנתא לא צריך לעלות על 30%-35% מסך ההכנסה החודשית הפנויה של משק הבית.",
      en: "Monthly mortgage payments should not exceed 30%-35% of household net monthly income.",
      es: "El pago mensual no debería superar el 30%-35% de los ingresos netos del hogar.",
      fr: "Les mensualités ne doivent pas dépasser 30% à 35% des revenus nets du foyer.",
      ar: "يجب ألا يتجاوز القسط الشهري للرهن العقاري 30%-35% من صافي الدخل الشهري للأسرة.",
    },
    formulaOrRule: "Max Monthly Payment <= Net Income * 0.33",
    calcPath: "/mortgage-calculator",
  },
  {
    id: "car_20_4_10",
    category: "finance",
    icon: "directions_car",
    title: {
      he: "כלל 20/4/10 ברכישת רכב",
      en: "The 20/4/10 Auto Rule",
      es: "Regla 20/4/10 para Comprar Auto",
      fr: "Règle 20/4/10 pour l'Achat Auto",
      ar: "قاعدة 20/4/10 لشراء السيارات",
    },
    summary: {
      he: "לפחות 20% מקדמה, מימון לעד 4 שנים, וסה״כ הוצאות רכב חודשיות שלא יעלו על 10% מההכנסה.",
      en: "20% down payment, finance for max 4 years, total monthly auto costs under 10% income.",
      es: "20% enganche, financiar máximo 4 años, y gastos de auto menores al 10% del ingreso.",
      fr: "20% d'apport, 4 ans de crédit max, et coût total inférieur à 10% du salaire.",
      ar: "دفعة أولى 20%، تمويل لمدة 4 سنوات كحد أقصى، وإجمالي تكاليف السيارة أقل من 10% من الدخل.",
    },
    formulaOrRule: "20% Down | 4 Years Max | <= 10% Income",
    calcPath: "/calculators/auto-loan",
  },
  {
    id: "mbps_to_mbs",
    category: "tech",
    icon: "speed",
    title: {
      he: "המרת מהירות אינטרנט (Mbps ל-MB/s)",
      en: "Internet Speed: Mbps to MB/s",
      es: "Velocidad de Internet: Mbps a MB/s",
      fr: "Vitesse Internet : Mbps en Mo/s",
      ar: "سرعة الإنترنت: التحويل من Mbps إلى MB/s",
    },
    summary: {
      he: "ספקי אינטרנט מפרסמים במהירות Megabits (Mb). חלק ב-8 כדי לדעת את מהירות ההורדה הממשית ב-Megabytes (MB/s).",
      en: "ISPs sell speeds in Megabits (Mb). Divide by 8 to get real download speed in Megabytes (MB/s).",
      es: "Los proveedores venden en Megabits (Mb). Divide entre 8 para saber la velocidad real en MB/s.",
      fr: "Les FAI vendent en Mégabits (Mb). Divisez par 8 pour obtenir le débit réel en Mégaoctets (Mo/s).",
      ar: "شركات الإنترنت تعلن بالميجابت. اقسم على 8 لمعرفة سرعة التنزيل الفعلية بالميجابايت في الثانية.",
    },
    formulaOrRule: "100 Mbps / 8 = 12.5 MB/s",
    calcPath: "/calculators/download-time",
  },
  {
    id: "mental_percent_tip",
    category: "math",
    icon: "psychology",
    title: {
      he: "טריק לחישוב 15% או 20% בראש",
      en: "Fast Mental Tip & % Calculation",
      es: "Truco Mental para Porcentajes",
      fr: "Calcul Mental d'un Pourcentage",
      ar: "حيلة الحساب الذهني للنسبة المئوية",
    },
    summary: {
      he: "הזז את הנקודה העשרונית שמאלה כדי לקבל 10%, ואז הכפל ב-2 עבור 20%, או הוסף חצי מזה עבור 15%.",
      en: "Move decimal 1 spot left for 10%, then double for 20% or add half for 15%.",
      es: "Mueve el punto 1 lugar a la izquierda para el 10%, duplica para el 20% o suma la mitad para el 15%.",
      fr: "Décalez la virgule d'un rang à gauche pour 10%, doublez pour 20% ou ajoutez la moitié pour 15%.",
      ar: "حرك الفاصلة العشرية خانة واحدة لليسار للحصول على 10%، ثم ضاعف لـ 20% أو أضف النصف لـ 15%.",
    },
    formulaOrRule: "15% of $80 = ($8 + $4) = $12",
    calcPath: "/percentage-finder",
  },
];
