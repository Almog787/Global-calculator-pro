...
async function submitIndexNow() {
  ...
  if (urlList.length === 0) {
    ...
    const paths = [
      ...
      '/calculators/linear-system',
      '/calculators/base-converter',
      '/calculators/bitwise-calculator',
      '/calculators/triangle-solver',
      '/calculators/circle-sector',
      '/calculators/matrix-calculator',
      '/calculators/complex-numbers',
      '/all',
      '/widgets',
      '/category/finance',
